...
** Created by: Arslan Saeed(Navigator), Nabil Khatri(Driver)
...
<img src='https://i.imgur.com/DRm4QNv.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />

GIF created with [LiceCap](http://www.cockos.com/licecap/).

## Notes

One of the image url requests was returning nil even though there was a check that it was not nil. This kept crashing the app. I made the value optional to fix this and spent about 45 minutes to resolve this alone. 
